...
Defined in: [fields/email.ts:20](https://github.com/iamceeso/verikit/blob/b02d6adb19170825b6578c0db30e2917049e5aff/packages/core/src/fields/email.ts#L20)
...
`Omit`\<[`EmailFieldSchema`](../interfaces/EmailFieldSchema.md), `"type"` \| `"name"`\> = `...`
