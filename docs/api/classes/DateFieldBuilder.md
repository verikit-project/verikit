...
[@verikit/core](../README.md) / DateFieldBuilder

# Class: DateFieldBuilder\<TValue\>

Defined in: [fields/date.ts:20](https://github.com/iamceeso/verikit/blob/b02d6adb19170825b6578c0db30e2917049e5aff/packages/core/src/fields/date.ts#L20)
...
Defined in: [fields/date.ts:23](https://github.com/iamceeso/verikit/blob/b02d6adb19170825b6578c0db30e2917049e5aff/packages/core/src/fields/date.ts#L23)

#### Parameters

##### state?

`Omit`\<[`DateFieldSchema`](../interfaces/DateFieldSchema.md), `"type"` \| `"name"`\> = `...`
