...
Defined in: [fields/number.ts:39](https://github.com/iamceeso/verikit/blob/b02d6adb19170825b6578c0db30e2917049e5aff/packages/core/src/fields/number.ts#L39)
...
`Omit`\<[`NumberFieldSchema`](../interfaces/NumberFieldSchema.md), `"type"` \| `"name"`\> = `...`
