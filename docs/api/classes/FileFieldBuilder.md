...
Defined in: [fields/file.ts:22](https://github.com/iamceeso/verikit/blob/b02d6adb19170825b6578c0db30e2917049e5aff/packages/core/src/fields/file.ts#L22)
...
`Omit`\<[`FileFieldSchema`](../interfaces/FileFieldSchema.md), `"type"` \| `"name"`\> = `...`
