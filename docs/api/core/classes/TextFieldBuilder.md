...
Defined in: fields/text.d.ts:10
...
Defined in: fields/text.d.ts:11

#### Parameters

##### state?

`Omit`\<[`TextFieldSchema`](../interfaces/TextFieldSchema.md), `"name"` \| `"type"`\>
...
Defined in: fields/text.d.ts:15
...
Defined in: fields/text.d.ts:13
