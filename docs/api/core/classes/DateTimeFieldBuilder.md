...
[@verikit/core](../core.md) / DateTimeFieldBuilder

# Class: DateTimeFieldBuilder\<TValue\>

Defined in: fields/date.d.ts:23
...
Defined in: fields/date.d.ts:24

#### Parameters

##### state?

`Omit`\<[`DateTimeFieldSchema`](../interfaces/DateTimeFieldSchema.md), `"name"` \| `"type"`\>
