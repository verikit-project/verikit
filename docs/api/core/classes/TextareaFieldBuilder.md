...
[@verikit/core](../core.md) / TextareaFieldBuilder

# Class: TextareaFieldBuilder\<TValue\>

Defined in: fields/textarea.d.ts:10
...
Defined in: fields/textarea.d.ts:11

#### Parameters

##### state?

`Omit`\<[`TextareaFieldSchema`](../interfaces/TextareaFieldSchema.md), `"name"` \| `"type"`\>
...
Defined in: fields/textarea.d.ts:15
...
Defined in: fields/textarea.d.ts:13
