...
/** Vue component capable of rendering a Verikit field schema. */
export type VerikitFieldComponent = Component<VerikitFieldComponentProps>;

/** Mapping from Verikit field types to their Vue renderers. */
